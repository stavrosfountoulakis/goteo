    ...
    <div class="user-pool">
      ...
      <div class="row">
        <div class="col-xs-6 text-right">
            <a href="/discover"  class="btn btn-lg btn-light-blue"><?= $this->text('dashboard-my-wallet-contribute-button') ?></a>
        </div>
        <div class="col-xs-6 text-left">
            <a href="/pool"  class="btn btn-lg btn-gold"><?= $this->text('recharge-button') ?></a>
        </div>
      </div>
    </div>
  </div>
